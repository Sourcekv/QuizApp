...
function App() {
  ...
  const reset = () => { setAnswerStatus(null); setScreen('home'); }
  ...
  const submit = () => {
    setSubmitted(true);
    const result = evaluateQuestion(current, answers[current.id]);
  ...
  return (
    <div className="app-shell">
      ...
      <Mascot screen={screen} answerStatus={answerStatus} score={score} total={quiz.length} />
    </div>
  );
}
